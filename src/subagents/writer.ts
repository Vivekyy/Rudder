...
Inactive rules are intentionally retired. Do not UPDATE or NOOP an inactive rule. If an inactive rule semantically matches a NEW rule you would otherwise write, abort that NEW candidate; if no candidates remain, return {"signal":false,"reason":"inactive rule already retired this behavior","candidates":[]}.
