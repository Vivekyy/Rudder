 ...
 * is available or the call fails, prompts are simply left untagged (and folded
 * into housekeeping by {@link statsForDay} until a later pass tags them).
 * Returns the count of prompts still untagged afterward.
 */
